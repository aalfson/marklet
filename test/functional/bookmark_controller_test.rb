...
class BookmarkControllerTest < ActionController::TestCase
  ...
  test "should create bookmark" do
    ...
    post :create, url: "www.google.com", title: "Google", id: '1', method: 'post'
    ...
    assert b.user.id == 1, "bookmark user id = " + b.user.id.to_s
  end
  ...
  test "should update bookmark" do
    ...
    post :update, url: "http://news.ycombinator.com/", title: "Hacker News", id: b.id
